...
function displaySelectedSol(sols) {
    ...
    currentTempHighElement.innerText = displayTemprature(selectedSol.maxTemp)
    currentTempLowElement.innerText = displayTemprature(selectedSol.minTemp)
...
function displayPreviousSols(sols) {
	...
	sols.forEach((solData, index) => {
		...
		solContainer.querySelector('[data-temp-high]').innerText = displayTemprature(solData.maxTemp)
		solContainer.querySelector('[data-temp-low]').innerText = displayTemprature(solData.minTemp)
...
function displayTemprature (temprature) {
    let returnTemp = temprature
    if(!isMetric()) {
        returnTemp = (temprature) * (9 / 5) + 32
    }
